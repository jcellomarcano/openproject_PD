...
If you chose **Two-way OAuth 2.0 authorization code flow** as an authentication strategy, you will have to configure OAuth authentication between OpenProject and Nextcloud in both directions.
